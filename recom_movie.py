...
df_rating.write.format("com.mongodb.spark.sql.DefaultSource").mode("overwrite").option("database","Project").option("collection", "rating").save()
...
df_movies.write.format("com.mongodb.spark.sql.DefaultSource").mode("overwrite").option("database","Project").option("collection", "movies").save()
